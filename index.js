...
const dbUrl = "mongodb+srv://admin:senha123@cluster0.jdrlaot.mongodb.net"
...
async function main() {
  ...
  app.get("/item/:id", async function (req, res) {
    ...
    // Acessamos o item na collection
  ...
  app.put("/item/:id", async function (req, res) {
    ...
    // o ID para garantir que atualizamos
    // o item correto
